...
if (msg == "!후보조건") {
	replier.reply("《후보조건》\n▼내용확인▼" + blank + "현 중학교 1학년 이상, 접률 높음(캬옹봇 채팅수 기준 1000회 이상이면 좋음), 객관적인 판단을 할 자신이 있고 끝까지 방 관리를 책임지고 할 수 있는 사람, 컴퓨터에 대해 어느정도 아는 사람\n\n후보등록 취소,수정 불가능\n후보등록방법: 아래와 같이 입력(엔터로만 구분, 엔터 2번 이상 사용금지)\n》경고 문법 오류시 공란으로 표시될 수 있으니 엔터에 주의할것 특히 PC버전 실수로 안보내게 주의《\n\n!후보등록\n(첫번째줄: 자신의 스펙, 활동이력, 자기가 방에 어떤 기여를 했는지 등 자기소개)\n(두번째줄: 하고싶은말,다짐 등 한마디)") 	
...
if (msg == "!선거현황"||DB.ncounter==100||DB.ncounter==200) {
	DB.list = new Array;
	DB.list.push("\n\n\n\《!선거?》로 선거 관련 명령어를 확인하세요.\n※후보가 차후 더 출마될 가능성이 있으므로 표를 아껴 주시기 바랍니다※\n\n차기 부방장을 뽑는 선거이니만큼 각 후보를 꼼꼼하게 확인 후 《!투표 <기호>》 로 투표하세요.(취소불가능) 일인당 3개의 투표권이 있습니다. 부정선거시 강력 제제가 가해집니다.\n\n<《득표현황》>\n")
