            ...
            */
            ...
            try {
                if (msg.indexOf("!롤전적") == 0) {
                    ...
                    var u = org.jsoup.Jsoup.connect("http://www.op.gg/summoner/userName=" + msgi.substr(4)).header("Accept-Language", "ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7").get().html(); //변수 u는 이링크를 HTML파싱한 값이다
                    var t = u.select(".tierRank"); //변수 a는 변수 u에서 HTML에 <span class="tierRank"> 을 자른값 입니다 /이걸로 해서 tierRank부분을 자른겁니다
                    var w = u.split(".wins"); //나머지도 마찬가지입니다
                    var l = u.split(".losses");
                    var win = u.split(".winratio");
